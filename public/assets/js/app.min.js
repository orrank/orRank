! function(n) {
    ...
    if (theme ==='dark'){
        ($("#bootstrap-stylesheet").attr("href", "/assets/css/bootstrap-dark.min.css"), $("#app-stylesheet").attr("href", "/assets/css/app-dark.min.css"))
        $('#light-mode-switcher').show();
        $('#dark-mode-switcher').hide();
    }else{
        ($("#bootstrap-stylesheet").attr("href", $("#bootstrap-stylesheet").attr("href")), $("#app-stylesheet").attr("href", $("#app-stylesheet").attr("href")))
        $('#light-mode-switcher').hide();
        $('#dark-mode-switcher').show();
    } 
...
function(e) {
    ...
    t.prototype.init = function() {
        ...
        e("#light-mode-switcher").on("click", function() {
            (t.$bootstrapStylesheet.attr("href", t.$originalBSStylesheet), t.$appStylesheet.attr("href", t.$originalAppStylesheet))
            localStorage.setItem("data-theme", "light")
            $('#light-mode-switcher').hide();
            $('#dark-mode-switcher').show();

        }),
        e("#dark-mode-switcher").on("click", function() {
            (t.$bootstrapStylesheet.attr("href", e(this).data("bsstyle")), t.$appStylesheet.attr("href", e(this).data("appstyle")))
...
$("#selectfileTag").on('click', function(){
    $("#inputImg").click();
})
